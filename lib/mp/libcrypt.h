...
_TYPE( void ) bufToBig P((unsigned char *buf,
			  int buflen,
			  BigInt big));
_TYPE( void ) bufToBig_be P((unsigned char *buf,
			  int buflen,
			  BigInt big));
...
_TYPE( void ) bigToBuf P((BigInt big,
			  int bufsize,
			  unsigned char *buf));
_TYPE( void ) bigToBuf_be P((BigInt big,
			  int bufsize,
			  unsigned char *buf));
 ...
 * bigCompareX: do the right thing with signed integers.
 */
_TYPE( int ) bigCompare P((BigInt a, BigInt b));
_TYPE( int ) bigCompareX P((BigInt a, BigInt b));
 ...
 */
_TYPE( unsigned long ) truerand(void);
/************************************************************************/
/*	quantization		*/
